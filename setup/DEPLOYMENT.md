...
2. Use the provided `setup/docker-compose.edge-functions.yaml`
...
Use the provided `setup/docker-compose.edge-functions.yaml`:
...
| `setup/docker-compose.edge-functions.yaml` | Edge functions Docker setup (for Coolify) |
